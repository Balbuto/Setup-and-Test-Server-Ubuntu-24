...
**Файл:** `/etc/sysctl.d/99-server.conf`  
...
**Файл:** `/etc/sysctl.d/99-server-highload.conf`  
**Limits:** `/etc/security/limits.d/99-server-highload.conf`
...
Откат HIGHLOAD:
```bash
rm /etc/sysctl.d/99-server-highload.conf
rm /etc/security/limits.d/99-server-highload.conf
sysctl --system
```
